...
export const CITY_NAME_TO_ID: Record<string, string> = {
  ...
  '长汀': '101230702', '龙岩': '101230701', '赣州': '101240701', '漳州': '101230601',
  '三明': '101230801', '莆田': '101230401', '宁德': '101230301', '南平': '101230901',
};
...
export const CHINA_CITY_COORDINATES: Array<{ id: string; name: string; lat: number; lon: number }> = [
  ...
  { id: '101230702', name: '长汀', lat: 25.8300, lon: 116.3600 },
  { id: '101230701', name: '龙岩', lat: 25.0784, lon: 117.0176 },
  { id: '101240701', name: '赣州', lat: 25.8318, lon: 114.9336 },
  { id: '101230601', name: '漳州', lat: 24.5128, lon: 117.6472 },
  { id: '101230801', name: '三明', lat: 26.2635, lon: 117.6387 },
  { id: '101230401', name: '莆田', lat: 25.4540, lon: 119.0078 },
  { id: '101230301', name: '宁德', lat: 26.6657, lon: 119.5479 },
  { id: '101230901', name: '南平', lat: 26.6433, lon: 118.1777 },
];
